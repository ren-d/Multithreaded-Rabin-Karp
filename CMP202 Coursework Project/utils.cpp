...
void load_small_text(string& str) {
	// Read the whole file into str.
	load_file("short example.txt", str);

	// Extract only the main text of the book, removing the Project Gutenberg
	// header/footer and indices.

}
void load_medium_text(string& str) {
	// Read the whole file into str.
	load_file("medium example.txt", str);

	// Extract only the main text of the book, removing the Project Gutenberg
	// header/footer and indices.

}
void load_large_text(string& str) {
	// Read the whole file into str.
	load_file("long example.txt", str);
